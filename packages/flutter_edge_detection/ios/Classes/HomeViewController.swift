    ...
    override func viewDidAppear(_ animated: Bool) {
        if self.isBeingPresented {
            ...
            if #available(iOS 15, *) {
                ...
                appearance.backgroundColor = MilitaryExamScannerTheme.primaryGreen
                ...
                appearanceTB.backgroundColor = MilitaryExamScannerTheme.primaryGreen
            ...
            present(cameraController, animated: true) {
                guard self.canUseGallery, let window = UIApplication.shared.keyWindow else {
                    return
                }
